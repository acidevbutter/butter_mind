...
class KnowledgeChunk(Base):
    ...
    # Dimension pinned to settings.embeddings_dimension (must match the sentence-transformers
    # model in core/embeddings/local_provider.py) — changing the model later requires a
    # migration + full re-embedding of existing chunks.
