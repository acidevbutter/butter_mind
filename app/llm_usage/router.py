...
from app.core.dependencies import DbSession, RequireInternalApiKey
...
@router.get("/budgets/{flow}", response_model=LLMBudgetLimitRead | None, summary="Get a flow budget")
...
@router.put("/budgets/{flow}", response_model=LLMBudgetLimitRead, summary="Set a monthly flow budget")
